class Subject:
    ...
    def subject_name(self, subject_name):
        ...
        if len(subject_name) > 50:
            raise ValueError("과목명은 50자 이하로 입력하세요")
    ...
    def description(self, description):
        ...
        if len(description) > 200:
            raise ValueError("과목 설명은 200자 이하로 입력하세요")
...
class Task:
    ...
    def title(self, title):
        ...
        if len(title) > 100:
            raise ValueError("과제 제목은 100자 이하로 입력하세요")
        self.__title = title
    ...
    def content(self, content):
        self.__content = (content or "").strip()
    ...
    def priority(self, priority):
        ...
        if len(priority) > 10:
            raise ValueError("우선순위는 10자 이하로 입력하세요")
    ...
    def status(self, status):
        ...
        if len(status) > 10:
            raise ValueError("상태는 10자 이하로 입력하세요")
